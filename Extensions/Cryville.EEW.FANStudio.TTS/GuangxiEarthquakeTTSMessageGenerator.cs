...
namespace Cryville.EEW.FANStudio.TTS {
	public class GuangxiEarthquakeTTSMessageGenerator : IContextedGenerator<GuangxiEarthquake, ITTSMessageGeneratorContext, TTSEntry?> {
		public TTSEntry? Generate(GuangxiEarthquake e, ITTSMessageGeneratorContext? context, ref CultureInfo culture) {

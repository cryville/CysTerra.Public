...
namespace Cryville.EEW.FANStudio.TTS {
	public class BeijingEarthquakeTTSMessageGenerator : IContextedGenerator<BeijingEarthquake, ITTSMessageGeneratorContext, TTSEntry?> {
		public TTSEntry? Generate(BeijingEarthquake e, ITTSMessageGeneratorContext? context, ref CultureInfo culture) {

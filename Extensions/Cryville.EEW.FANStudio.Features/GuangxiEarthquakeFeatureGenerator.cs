...
namespace Cryville.EEW.FANStudio.Features {
	public class GuangxiEarthquakeFeatureGenerator : IGenerator<GuangxiEarthquake, Feature> {
		public Feature Generate(GuangxiEarthquake e, ref CultureInfo culture) {

...
namespace Cryville.EEW.FANStudio.Features {
	public class NingxiaEarthquakeFeatureGenerator : IGenerator<NingxiaEarthquake, Feature> {
		public Feature Generate(NingxiaEarthquake e, ref CultureInfo culture) {

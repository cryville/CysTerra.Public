...
namespace Cryville.EEW.Wolfx.Features {
	public class SichuanEEWFeatureGenerator : IGenerator<SichuanEEW, Feature?> {
		public Feature? Generate(SichuanEEW e, ref CultureInfo culture) {
		...
		static Feature GenerateFromEarthquake(SichuanEEW e) {
			var f = new Feature {
				{ Is, Earthquake },
				{ Ongoing, true },
		...
		static Feature GenerateFromLocation(SichuanEEW e) {

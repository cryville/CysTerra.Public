...
namespace Cryville.EEW.FANStudio {
	public sealed class GuangxiEarthquakeReportGenerator : IContextedGenerator<GuangxiEarthquake, IReportGeneratorContext, ReportModel> {
		public ReportModel Generate(GuangxiEarthquake? e, IReportGeneratorContext? context, ref CultureInfo culture) {
			ThrowHelper.ThrowIfNull(e);
			context ??= EmptyReportGeneratorContext.Instance;

			using var lres = new LocalizedResource(nameof(GuangxiEarthquake), ref culture);
